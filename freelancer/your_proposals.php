...
<!doctype html>
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <h4 class="text-center">Double-click to edit your proposals and then press enter to save.</h4>
                  ...
                  <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="form-control category-dropdown" name="category_id" required>
                          <option value="">Select Category</option>
                          <?php 
                            $categories = $categoryObj->getCategories(); 
                            foreach ($categories as $cat): ?>
                              <option value="<?= $cat['category_id']; ?>" 
                                <?= ($proposal['category_id'] == $cat['category_id']) ? 'selected' : ''; ?>>
                                <?= $cat['category_name']; ?>
                              </option>
                          <?php endforeach; ?>
                        </select>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="form-control subcategory-dropdown" name="subcategory_id" required>
                          <option value="">Select Subcategory</option>
                          <?php 
                            $subcategories = $subcategoryObj->getSubcategoriesByCategory($proposal['category_id']); 
                            foreach ($subcategories as $sub): ?>
                              <option value="<?= $sub['subcategory_id']; ?>" 
                                <?= ($proposal['subcategory_id'] == $sub['subcategory_id']) ? 'selected' : ''; ?>>
    ...
    <script>
      ...
      $(document).on("change", ".category-dropdown", function(){
          ...
          var subSelect = $(this).closest("form").find(".subcategory-dropdown");
